...
<body>
	...
	<div class="main">
		<div class="container my-2">
			<form class="login-form" method="post" action="/doctor/add">
				<table class="table table-striped table-responsive-md" border="1">
					...
					<tr>
						<td><input type="text" name="dmobile"
							placeholder="Doctor's Mobile Number" required>
					<tr>
						<td><select id="dspecialization" name="dspecialization" required>
								<option disabled selected>---Doctor's Specialization---</option>
								<c:forEach var="list" items="${list}">
									<option value="${list.getSname()}">${list.getSname()}</option>
								</c:forEach>
						</select></td>
					</tr>
					<tr>
