...
<title>Surgery Find By Name</title>
<style>
.formright {
	text-align: right;
}
...
<body>
	...
	<h3 align="center">
		<font><strong>Find Surgery Details by Name</strong></font>
	</h3>
	<h5 align="center">${error}</h5>
	<div class="main">
		<div class="container my-2">
			<form class="login-form" method="post" action="/charges/userfindbyname">
				<table class="table table-striped table-responsive-md" border="1">
					<tr>
						<td><select id="sname" name="sname" required>
