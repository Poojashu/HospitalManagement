...
<body>
	...
	<h3 align="center">
		<font><strong>Find Doctor Details by ID</strong></font>
	</h3>
	<h5 align="center">${error}</h5>
	<div class="main">
		<div class="container my-2">
			<form class="login-form" method="post" action="/doctor/userfindbyid">
				<table class="table table-striped table-responsive-md" border="1">
					<tr>
						<td><input type="number" name="did" placeholder="Doctor's ID" required></input></td>
					</tr>
					<tr>
