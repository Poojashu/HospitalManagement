...
<title>Staff Find By Name</title>
<style>
.formright {
	text-align: right;
}
...
<body>
	...
	<h3 align="center">
		<font><strong>Find Staff Details by Name</strong></font>
	</h3>
	<h5 align="center">${error}</h5>
	<div class="main">
		<div class="container my-2">
			<form class="login-form" method="post" action="/staffs/userfindbyname">
				<table class="table table-striped table-responsive-md" border="1">
					<tr>
						<td><input type="text" name="sname" placeholder="Staff's Name" required></input></td>
					</tr>
					<tr>
