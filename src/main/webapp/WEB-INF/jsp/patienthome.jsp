...
<body>
	...
	<h3 align="center">
		<font><strong>PATIENT'S PAGE</strong></font>
	</h3>
	<form method="get" action="/patient/add" class="formright">
	...
	<div class="main">
		<div class="inner">
			<div class="container my-2">
				<table class="table table-striped table-responsive-md" border="1">
					...
					<c:forEach var="list" items="${list}">
						<tr color="black">
							...
							<td>${list.getPname()}</td>
							<td><form method="post"
									action="/patient/view/${list.getPid()}">
									<button class="btn btn-primary">View</button>
								</form></td>
							<td><a href="/patient/update/${list.getPid()}"
								class="btn btn-primary">Update</a> <a
								href="/patient/delete/${list.getPid()}" class="btn btn-danger"
				...
				<br> <a href="/patient/onhold" class="btn btn-primary">On
					Hold List</a>
			</div>
		</div>
	</div>
