...
<body>
	...
	<h3 align="center">
		<font><strong>STAFF DETAILS</strong></font>
	</h3>
	<div class="main">
		<div class="inner">
			<div class="container my-2">
				...
				<table class="table table-striped table-responsive-md" border="1">
					<h3 align="center">
						<font><strong>Staffs Available</strong></font>
					</h3>
					<tr>
						<th><b>Staff's ID</b></th>
						<th><b>Staff's Name</b></th>
						<th><b>Full Details</b></th>
					</tr>
					<c:forEach var="list3" items="${list3}">
						<tr>
							<td>${list3.getSid()}</td>
							<td>${list3.getSname()}</td>
							<td><form method="post" action="/staffs/userview/${list3.getSid()}">
									<button class="btn btn-primary">View</button>
								</form></td>
						</tr>
					</c:forEach>
