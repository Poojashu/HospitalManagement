...
<body>
	...
	<h3 align="center">
		<font><strong>STAFF'S PAGE</strong></font>
	</h3>
	<form method="get" action="/staffs/add" class="formright">
				...
				<table class="table table-striped table-responsive-md" border="1">
					...
					<c:forEach var="list" items="${list}">
						<tr color="black">
							<td>${list.getSid()}</td>
							<td>${list.getSname()}</td>
							<td><form method="post" action="/staffs/view/${list.getSid()}">
									<button class="btn btn-primary">View</button>
								</form></td>
							<td><a href="/staffs/update/${list.getSid()}"
								class="btn btn-primary">Update</a> <a
								href="/staffs/delete/${list.getSid()}" class="btn btn-danger"
