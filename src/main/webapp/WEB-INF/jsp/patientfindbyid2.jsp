...
<title>Patient Find By ID</title>
<style>
.formright {
	text-align: right;
}
...
<body>
	...
	<h3 align="center">
		<font><strong>Find Patient Details by ID</strong></font>
	</h3>
	<h5 align="center">${error}</h5>
	<div class="main">
		<div class="container my-2">
			<form class="login-form" method="post" action="/patient/userfindbyid">
				<table class="table table-striped table-responsive-md" border="1">
					<tr>
						<td><input type="number" name="pid" placeholder="Patient's ID" required></input></td>
					</tr>
					<tr>
