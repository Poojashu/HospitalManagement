...
<body>
	...
	<h3 align="center">
		<font><strong>PATIENT'S DETAILS</strong></font>
	</h3>
	<div class="main">
		<div class="inner">
			<div class="container my-2">
				<table class="table table-striped table-responsive-md" border="1">
					<c:forEach var="list" items="${list}">
						...
						<tr>
							<th><b>Gender</b></th>
							<td>${list.getPgender()}</td>
						</tr>
						<tr>
							<th><b>Surgery Name</b></th>
							<td>${list.getPsurgery()}</td>
						</tr>
						<tr>
							<th><b>Address</b></th>
						...
						<tr>
							<th><b>Doctor Availability & ID</b></th>
							<td>${list.getDocavail()} - ${list.getDid()}</td>
						</tr>
						<tr>
							<th><b>Staff Availability & ID</b></th>
							<td>${list.getStaffavail()} - ${list.getSid()}</td>
						</tr>
					</c:forEach>
				</table>
				<div class="bton">
